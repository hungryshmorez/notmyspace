...
export const shows: Show[] = [
  {
    ...
    longDescription:
      'Broadcasting from a glitchy, CRT-filtered void that feels like a pirate public-access channel operated by digital ghosts, Al and Sloppy sit on a stained thrift-store couch and react to cursed, broken and unintentionally hilarious synthetic media. The Showrunner keeps the content machine alive while Buffer reports from places nobody should have sent him.',
  ...
  },
  {
    slug: 'channel-86',
    title: 'Channel 86',
    eyebrow: 'SURREAL MYSTERY',
    blurb: 'A local television station that officially does not exist begins broadcasting every night at 2:13 A.M.',
    longDescription: 'Bellweather has channels 85 and 87. Channel 86 is not listed, licensed or supposed to exist — but it appears every night anyway.',
    status: 'DEVELOPMENT',
    heroKind: 'tv',
    episodes: [],
    characters: [],
  ...
  },
  {
    ...
    status: 'ACTIVE',
    heroKind: 'record',
    cardImage: '/brand/records-card.webp',
  },
]
